...
var RouteNavigator = function(firstStep,instructionDivTemp,distanceDivTemp, DirectionsTemp) {
  ...
  this.arrived = 0;
  this.lastHeading;
  this.currentIntersectionsArray = {var tempArr = []; for (var i = 0; i < this.steps.length; i++) {for (var j = 0; j < this.steps[i].intersections.length; j++) tempArr.push( this.steps[i].intersections[j] );}; return tempArr; }

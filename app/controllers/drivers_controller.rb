class DriversController < ApplicationController
	...
	def checkForRideRequests
		...
		if (driverCurrentStatus.trip_status == "requesting")
			...
			directions = Driver.get_directions(nil, trip_request.pickup_longitude, trip_request.pickup_latitude, trip_request.destination_longitude, trip_request.destination_latitude)
